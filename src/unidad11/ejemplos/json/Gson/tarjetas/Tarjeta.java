...
public class Tarjeta {
	...
	public Tarjeta(String tipo_de_tarjeta, String numero_de_tarjeta, String numero_de_cuenta_asociada, String titular,
	...
	public String toString() {
		return "tipo_de_tarjeta=" + tipo_de_tarjeta + "\n numero_de_tarjeta=" + numero_de_tarjeta
				+ "\n numero_de_cuenta_asociada=" + numero_de_cuenta_asociada + "\n titular=" + titular
